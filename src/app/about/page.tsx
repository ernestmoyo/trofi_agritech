    ...
    <main className="min-h-screen bg-gray-50">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-14">
          ...
          <div className="bg-white rounded-2xl p-8 md:p-10 shadow-lg border border-gray-100 relative overflow-hidden">
            ...
            <p className="text-gray-600 leading-relaxed text-lg">
              To bridge Africa&rsquo;s agricultural data silos and empower evidence-based
          ...
          <div className="bg-white rounded-2xl p-8 md:p-10 shadow-lg border border-gray-100 relative overflow-hidden">
            ...
            <p className="text-gray-600 leading-relaxed text-lg">
              ...
              farming decision is informed by intelligence.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        <div className="text-center mb-14">
          <h2 className="section-title mb-4">Our Approach &mdash; Five Pillars</h2>
          <p className="section-subtitle">
            Five interconnected modules that together form a comprehensive agricultural intelligence
              ...
              <div className="grid md:grid-cols-5 gap-8 md:gap-12 items-start">
                ...
                <div className="md:col-span-3">
                  <p className="text-gray-700 leading-relaxed mb-6">
                    Isabel is a visionary leader driving the transformation of agricultural data in
                    Africa. With deep expertise in agribusiness and technology, she founded Trofi
                    AgriTech to address the critical gap in integrated agricultural intelligence
                    across the continent.
                  </p>
                  <p className="text-gray-700 leading-relaxed mb-6">
                    Her mission is to ensure that every African nation has access to the data
                    infrastructure needed to make evidence-based agricultural policy and investment
                    decisions. Under her leadership, Trofi AgriTech is positioned at the intersection
                    of the Kampala CAADP Declaration and the AU Digital Agriculture Strategy, building
                    the integration layer that Africa&rsquo;s food systems need.
                  </p>
                  ...
                  <div className="bg-white rounded-xl p-6 border border-trofi-200 relative">
                    ...
                    <p className="text-trofi-800 italic leading-relaxed font-medium">
                      &ldquo;Africa&rsquo;s agricultural future depends on our ability to connect the dots
                      between policy, trade, production, and technology. That&rsquo;s exactly what Trofi
                      AgriTech does.&rdquo;
                    </p>
